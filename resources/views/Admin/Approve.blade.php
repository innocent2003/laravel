        ...
        <div class="row fs-3 my-5">
            ...
            <main class=" col-12 col-lg-10 ">
                <div class="">
                    ...
                    <div class="ms-3">
                        <form method="POST" action="{{ route('data.updateIsActive', ['id' => $data->id]) }}">
                            @csrf
                            <div class="">
                                <div>Tên sản phẩm</div>
                                <input type="text" class="w-75 rounded" value="{{$data->dataname}}">
                                <input type="hidden" name="" value="{{$data->user_id}}">
                                <input type="hidden" name="" value="{{$data->idProduct}}">
                                <input type="hidden" name="" value="active">
                            </div>
                            <div class="">
                                <div>Mô tả</div>
                                <textarea name="description" id="description" rows="5" class="w-75 rounded">{{$data->description}}</textarea>
                            </div>
                            <div class="row w-75">
                            ...
                            @method('PUT')
                            <label for="is_active">Select is_active status:</label>
